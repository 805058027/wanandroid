...
import com.example.administrator.wanandroid.net.cookie.MyOkHttpClient;
        ...
        return new Interceptor() {
            ...
            public Response intercept(@NonNull Chain chain) throws IOException {
                ...
                Request.Builder requestBuilder = original.newBuilder()
                        //添加Token
                        .header("Cookie", "loginUserName=" + preferencesUtil.getString("mUserName"))
                        .header("Cookie", "loginUserPassword=" + preferencesUtil.getString("mPassWord"));
